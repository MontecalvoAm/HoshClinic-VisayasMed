...
export default function DoctorsPage() {
  const doctors = [
    { id: "DOC-01", name: "Dr. Elena Smith", specialty: "General Medicine", status: "Active", appointments: 12, rating: 4.9 },
    { id: "DOC-02", name: "Dr. Marcus Adams", specialty: "Cardiology", status: "Active", appointments: 8, rating: 4.8 },
    { id: "DOC-03", name: "Dr. Sarah Evans", specialty: "Pediatrics", status: "On Leave", appointments: 0, rating: 5.0 },
    { id: "DOC-04", name: "Dr. James Wilson", specialty: "Dermatology", status: "Active", appointments: 15, rating: 4.7 },
  ];
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-zinc-900">Doctor Management</h1>
          <p className="text-zinc-500">Manage medical staff profiles and schedules.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {doctors.map((doctor) => (
          <div key={doctor.id} className="bg-white p-6 rounded-3xl border border-zinc-100 shadow-sm hover:shadow-xl transition-all group">
            ...
            <div className="mt-6 pt-6 border-t border-zinc-50 flex items-center justify-around text-center">
              <div>
                <p className="text-xs text-zinc-400 uppercase font-bold tracking-wider">Apts</p>
